                  ...
                  >
                    {navItems.map((item) =>
                      "items" in item ? (
                        ...
                        >
                          <AccordionTrigger className="px-5 py-4 hover:no-underline hover:bg-accent/15 transition-all duration-200 group">
                        ...
                        <Link
                          key={item.label}
                          href={item.href}
                          className="flex items-center justify-between w-full px-5 py-4 border border-border/30 rounded-xl hover:border-accent/40 transition-all duration-300 group bg-card/60 hover:bg-card/90 backdrop-blur-sm shadow-sm hover:shadow-md"
                          onClick={() => setIsMenuOpen(false)}
                        >
                          <span className="flex items-center gap-3">
                            <span className="group-hover:text-accent transition-colors duration-200">
