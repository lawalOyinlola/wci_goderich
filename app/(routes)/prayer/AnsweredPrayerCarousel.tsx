...
interface AnsweredPrayerCarouselProps {
...
export function AnsweredPrayerCarousel({
  testimonials,
  autoPlayInterval = 5000,
  onClose,
  className,
}: AnsweredPrayerCarouselProps) {
                ...
                <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8 md:p-10 border border-gray-200 dark:border-gray-700 hover:shadow-3xl transition-shadow duration-300 overflow-hidden">
                  ...
                  {isActive && (
                    <div
                      ...
                      style={{
                        background: `conic-gradient(from -90deg, rgb(59, 130, 246) 0deg, rgb(59, 130, 246) ${(progress / 100) * 360
                          }deg, transparent ${(progress / 100) * 360
